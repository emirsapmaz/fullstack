...
public class Service implements Iservice {
    ...
    private EmailDetails getApprovedCoachEmail(Coach coach) {
        ...
        details.setMsgBody(
                "Dear" + coach.getUsername() + ",\n" +
                        "\n" +
                        "We are pleased to inform you that your coaching account with PurePlate has been approved. Your extensive experience and qualifications have been recognized, and we believe that your expertise will greatly contribute to the success of our platform.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "Thank you for joining PurePlate. We look forward to a successful collaboration.\n" +
                        "\n" +
                        "Best regards,\n" +
                        "PurePlate Team");
        return details;
    ...
    private static EmailDetails getEmailDetails(String email, String name, String token) {
        ...
        String content = "Dear [[name]],<br>"
                + "Thank you for signing up with PurePlate!<br>"
                ...
                + "Thank you for choosing PurePlate!<br>"
                + "PurePlate team";
    ...
    public void sendForgetPasswordEmail(ResetPassword resetPassword) {
        ...
        String subject = "Please verify your registration";
        String content = "Dear [[name]],<br>" + "Here is the OTP code to forget password :<br>" + "<h3>[[URL]]</h3>" + "Thank you,<br>" + "PurePlate team";
